...
<html lang="en" class="scroll-smooth">
    ...
    <body>
        ...
        <a href="./create.php" class="items-center border border-black text-white bg-black hover:bg-white hover:text-black">Create</a>
        <div>
				...
				<tbody>
					<tr class="border-b dark:border-neutral-500">
                        <?php
                            ...
                            {
                        ?>
						<td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['useremail']; ?></td>
						<td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['userpass']; ?></td>
                        <td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['isactive'] ? '✔' : '❌'; ?></td>
						<td class="whitespace-nowrap px-6 py-2">
							<a class="cursor-pointer hover:underline hover:text-gray-700" @click="viewUser(user.id)">
								Read
							</a>
							<a href="../front-end/update.php?useracc_id=<?php echo $row["useracc_id"]; ?>" class="cursor-pointer hover:underline hover:text-gray-700">
								Update
							</a>
                            <a href="../back-end/delete.php?useracc_id=<?php echo $row['useracc_id']; ?>" class="cursor-pointer hover:underline hover:text-gray-700">
								Delete
							</a>
			    		</td>
					</tr>
