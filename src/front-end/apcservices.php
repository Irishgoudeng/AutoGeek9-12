...
$query = "SELECT * FROM tbl_services INNER JOIN tbl_servicetype ON tbl_services.servicetype_id = tbl_servicetype.servicetype_id";
...
<html lang="en" class="scroll-smooth">
    ...
    <body>
        ...
        <a href="./servicescreate.php" class="items-center border border-black text-white bg-black hover:bg-white hover:text-black">Create</a>
        <div>
        <table class="min-w-full text-left text-sm font-light">
			<thead class="border-b font-medium dark:border-neutral-500">
				<tr>
					<th scope="col" class="px-6 py-2">Service Name</th>
					<th scope="col" class="px-6 py-2">Service Type</th>
					<th scope="col" class="px-6 py-2">Service Desc</th>
                    <th scope="col" class="px-6 py-2">Service Price</th>
				</tr>
			</thead>
				<tbody>
					<tr class="border-b dark:border-neutral-500">
                        <?php
                            ...
                            {
                        ?>
						<td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['serv_name']; ?></td>
						<td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['service_type']; ?></td>
						<td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['service_desc']; ?></td>
						<td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['service_price']; ?></td>                                                        
						<td class="whitespace-nowrap px-6 py-2">
							<a class="cursor-pointer hover:underline hover:text-gray-700" @click="viewUser(user.id)">
								Read
							</a>
							<a href="../front-end/servicesupdate.php?service_id=<?php echo $row["service_id"]; ?>" class="cursor-pointer hover:underline hover:text-gray-700">
								Update
							</a>
                            <a href="../back-end/updateservices.php?service_id=<?php echo $row['service_id']; ?>" class="cursor-pointer hover:underline hover:text-gray-700">
								Delete
							</a>
			    		</td>
					</tr>
