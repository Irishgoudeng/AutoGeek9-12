    ...
    <div class="min-h-screen flex flex-row bg-gray-100">
        <div class="flex flex-col w-56 bg-black overflow-hidden">
            ...
            <ul class="flex flex-col py-4">
                ...
                <li>
                    <a href="./apcEmployees.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-yellow-400">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="bx bx-drink"></i></span>
        ...
        <div class="w-10/12 h-screen">
                ...
                <form>
                    <div class="flex w-80">
                        ...
                        <div class="relative w-full">
                            <input type="search" id="search-dropdown" class="block p-2.5 w-full z-20 text-sm text-gray-900 bg-gray-50 rounded-r-lg border-l-gray-50 border-l-2 border border-gray-300 focus:ring-blue-500 focus:border-black dark:bg-gray-700 dark:border-l-gray-700  dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:border-blue-500">
            ...
            <div class="grid grid-cols-2 my-5 pl-10">
                <h1 class="font-extrabold p-4">Appointments</h1>

                <button class="absolute right-24 bg bg-yellow-300 rounded-md p-2 font-sans font-light">+ Add New Appointment</button>
            ...
            <div class="overflow-hidden shadow-md sm:rounded-lg md:ml-12 w-full flex items-center justify-center">
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="pl-3">
                                    <div class="text-base font-semibold">A-01</div>
                                </div>
                            </th>
                            <td class="px-6 py-4">
                                Neil Sims
                            ...
                            <td class="px-6 py-4">
                                <!-- Modal toggle -->
                                <a href="#" type="button" data-modal-target="editAppointmentModal" data-modal-show="editAppointmentModal" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit user</a>
                            </td>
                        </tr>
                    </tbody>
                </table>
                ...
                <!-- Edit user modal -->
                <div id="editAppointmentModal" tabindex="-1" aria-hidden="true" class="fixed top-0 left-0 right-0 z-50 items-center justify-center hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
