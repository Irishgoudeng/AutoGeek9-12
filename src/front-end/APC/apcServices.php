    ...
    <div class="min-h-screen flex flex-row bg-gray-100">
        <div class="flex flex-col w-56 bg-black overflow-hidden">
            ...
            <ul class="flex flex-col py-4">
                ...
                <li>
                    <a href="./apcInventory.php" class="flex flex-row items-center h-12 transform hover:translate-x-2 transition-transform ease-in duration-200 text-gray-500 hover:text-yellow-400">
                        <span class="inline-flex items-center justify-center h-12 w-12 text-lg text-gray-400"><i class="bx bx-chat"></i></span>
        ...
        <div class="w-10/12 h-screen">
            ...
            <div class="grid grid-cols-2 my-5 pl-10">
                <h1 class="font-extrabold p-4">Services</h1>

                <button class="absolute right-24 bg bg-yellow-300 rounded-md p-2 font-sans font-light">+ Add New Service</button>
                    ...
                    <tbody>
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                            ...
                            <th scope="row" class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <div class="pl-3">
                                    <div class="text-base font-semibold">S-01</div>
                                </div>
                            </th>
                            <td class="px-6 py-4">
                                Change Oil
