...
<html lang="en" class="scroll-smooth">
    ...
    <body>
        ...
        <a href="./createinventory.php" class="items-center border border-black text-white bg-black hover:bg-white hover:text-black">Add</a>
        <div>
        <table class="min-w-full text-left text-sm font-light">
			<thead class="border-b font-medium dark:border-neutral-500">
				<tr>
					<th scope="col" class="px-6 py-2">Item Name</th>
					<th scope="col" class="px-6 py-2">Item Brand</th>
                    <th scope="col" class="px-6 py-2">Item Category</th>
                    <th scope="col" class="px-6 py-2">Item Quantity</th>
                    <th scope="col" class="px-6 py-2">Item Price</th>
				...
				<tbody>
					<tr class="border-b dark:border-neutral-500">
                        <?php
                            ...
                            {
                        ?>
						<td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['item_name']; ?></td>
                        <td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['item_brand']; ?></td>
                        <td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['item_category']; ?></td>
                        <td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['item_qty']; ?></td>
                        <td class="whitespace-nowrap px-6 py-2 font-medium"><?php echo $row['item_price']; ?></td>
						<td class="whitespace-nowrap px-6 py-2">
							<a class="cursor-pointer hover:underline hover:text-gray-700" @click="viewUser(user.id)">
								Read
							</a>
							<a href="../front-end/updateinventory.php?item_id=<?php echo $row["item_id"]; ?>" class="cursor-pointer hover:underline hover:text-gray-700">
								Update
							</a>
                            <a href="../back-end/delete.php?useracc_id=<?php echo $row['item_id']; ?>" class="cursor-pointer hover:underline hover:text-gray-700">
								Delete
							</a>
			    		</td>
					</tr>
