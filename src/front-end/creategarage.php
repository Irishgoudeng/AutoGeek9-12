                ...
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <div>
                            ...
                            <input type="radio" id="active_yes" name="garage_status" value="1" class="text-primary-600 form-radio" checked>
                            <label for="active_yes" class="text-sm text-gray-900 dark:text-white">Available</label>
    
                            <input type="radio" id="active_no" name="garage_status" value="0" class="text-primary-600 form-radio">
