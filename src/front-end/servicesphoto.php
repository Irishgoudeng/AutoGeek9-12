            ...
            <div class="flex flex-col items-center xl:mt-12 px-6 py-8 mx-auto lg:py-0">
                ...
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="../back-end/createservices.php" method="post">
                        ...
                        <?php } ?>
                            <div>
                                <label for="servicetype_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Service Photo</label>
                                <input
                                    type="file"
                                    name="servicetype_id"
                                    id="servicetype_id"
                            ...
                            <div>
                                <label for="service_desc" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Service ID</label>
                                <input
                                    type="text"
                                    name="service_desc"
                                    id="service_desc"
