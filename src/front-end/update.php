...
$useracc_id = $_GET['useracc_id']; // Get the useracc_id from the URL parameter
            ...
            <div class="flex flex-col items-center xl:mt-12 px-6 py-8 mx-auto lg:py-0">
                ...
                <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="../back-end/update.php?useracc_id=<?php echo $row['useracc_id']; ?>" method="post">
                        ...
                        <?php } ?>
                        <div>
                            <label for="useracc_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white"></label>
                            <input type="text" name="useracc_id" id="useracc_id" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            value="<?php echo $row['useracc_id']; ?>"><br>
